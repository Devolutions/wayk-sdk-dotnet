namespace Devolutions.Wayk.Now
{
    ...
    public partial class NowAuth : NowObject, IDisposable
    {
        ...
        public NowPfp Pfp
        {
            get
            {
                return pfp ?? (pfp = new NowPfp(NowAuth_GetPfp(this)));
            }
        }
        ...
        public string Password
        {
            get
            {
                return NowAuth_GetPassword(this);
            }
            set
            {
                NowAuth_SetPassword(this, value);
            }
        }
        ...
        public NowAuthType Type
        {
            get
            {
                return NowAuth_GetType(this);
            }
            set
            {
                NowAuth_SetType(this, value);
            }
        }
