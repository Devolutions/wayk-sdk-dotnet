namespace Devolutions.Wayk.Native
{
	...
	internal static partial class NativeNow
	{
        ...
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int NowSharee_Connect(IntPtr sharee, string hostname, int port, uint timeout, IntPtr handle);
        ...
        [DllImport(LibName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool NowSharee_RegisterCallback(IntPtr sharee, string name, Delegate function, IntPtr param);
